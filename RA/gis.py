...
if map_type_choice in ["Healthcare"]:
    ...
    if map_choice3 in ["Healthcare Facilities in Jordan"]:
        ...
        # Main data loading
        df = load_data("C:/Users/zzc01/Documents/RA/dataset/Healthcare Facilities in Jordan/healthcare.csv")
...
if map_type_choice in ["Boundaries"]:
    ...
    if map_choice1 in ["Boundaries of Jordan States", "Boundaries of Jordan"]:
        ...
        if map_choice1 in ["Boundaries of Jordan States"]:
            gdf_jstates, id_name_df = prepare_data("C:/Users/zzc01/Documents/RA/dataset/Jordan Boundaries/governorate.csv", "C:/Users/zzc01/Documents/RA/jordan_admin_regions.shp")
            gdf = gdf_jstates
        elif map_choice1 == "Boundaries of Jordan":
            gdf_jordan, id_name_df = prepare_data("C:/Users/zzc01/Documents/RA/dataset/Jordan Boundaries/country.csv", "C:/Users/zzc01/Documents/RA/jordan_admin_regions.shp")
            gdf = gdf_jordan
